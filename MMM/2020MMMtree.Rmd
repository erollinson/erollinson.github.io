...
```{r}
#circular tree
round<- ggtree(tree2, layout="circular") %<+% species2 + geom_tiplab2(size=3, aes(angle=angle, color=Division)) + scale_color_viridis_d(option="A") + theme(legend.position="right")
round
