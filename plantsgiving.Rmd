...
round<- ggtree(tree2, layout="circular") %<+% species2 + geom_tiplab(size=3, aes(angle=angle, color=Family)) + theme(legend.position="right")
round

ggsave(round, file="plantsgiving_color_round_family.pdf", width=30, height=30)
