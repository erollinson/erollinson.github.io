...
The code generating this document was originally developed by [François Michonneau](https://github.com/fmichonneau) ([fmic_](https://twitter.com/fmic_) on Twitter) for the 2015 Evolution meeting and can be found [here](https://github.com/fmichonneau/evol2015-tweets). 

It has since been [adapted](https://github.com/jlehtoma/iccb2015-tweets/blob/gh-pages/index.Rmd) for ICCB-ECCB 2015 by Joona Lehtomäki ([jlehtoma](https://twitter.com/jlehtoma) on Twitter).
...
Here, the code is adapted for the 2015 Ecological Society of America Meeting (ESA100) in Baltimore, MD, by Emily J. Rollinson ([ejrollinson](https://twitter.com/ejrollinson) on Twitter). 
...
This document was generated using RMarkdown, and the source is [available on GitHub](https://github.com/erollinson/ESA100-tweets).
